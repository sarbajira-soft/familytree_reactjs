...
const ProductDetail = ({ product, isOpen, onClose, onAddToCart }) => {
  ...
  const handleAddToCart = () => {
    ...
    onAddToCart(currentVariant.id, quantity);
  };
          ...
          <div className="flex flex-col gap-4 rounded-xl bg-white p-4">
            ...
            <div className="flex items-center justify-between gap-3 pt-2">
              ...
              <button
                ...
                className={`inline-flex flex-1 items-center justify-center gap-2 rounded-full px-4 py-2 text-sm font-semibold shadow-sm transition ${
                  inStock
