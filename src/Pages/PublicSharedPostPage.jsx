...
const PublicSharedPostPage = () => {
  ...
  if (token && userInfo && shareId) {
    return <Navigate to={`/app/shared-post/${encodeURIComponent(shareId)}`} replace />;
  }

  return <SharedPostView context="web" />;
};

export default PublicSharedPostPage;
