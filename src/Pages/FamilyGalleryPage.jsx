...
const getGalleryPillClassName = (isActive) =>
      ...
      <div className="mx-auto flex max-w-7xl flex-col px-4 py-8 md:px-6 lg:px-8">
        <div className="w-full">
          <div className="mb-6 space-y-3 lg:hidden">
            <button
              className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-[#2B7CD3] bg-[#2B7CD3] px-4 py-3 text-[14px] font-semibold text-white shadow-[0_8px_18px_rgba(43,124,211,0.18)] transition-all duration-200 hover:border-[#236AB4] hover:bg-[#236AB4] shimmer-button"
              onClick={() => setIsCreateAlbumModalOpen(true)}
            >
              <FiPlusCircle size={17} /> Create Album
            </button>

            <div className="flex min-w-0 items-center gap-2">
              <button
                onClick={() => setActiveFeed("public")}
                className={`${getGalleryPillClassName(activeFeed === "public")} shrink-0 px-3`}
              >
              ...
              {canAccessFamilyFeed ? (
                <button
                  ...
                  className={`${getGalleryPillClassName(activeFeed === "family")} shrink-0 px-3`}
                >
                  <span className="inline-flex h-4 w-4 shrink-0 items-center justify-center">
                    <MdPeople size={15} />
                  </span>
              ...
              <div className="min-w-0 flex-1">
                <input
                  ...
                  className="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-[13px] text-slate-700 shadow-sm outline-none transition focus:border-primary-400 focus:ring-2 focus:ring-primary-300/50 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:placeholder:text-slate-400"
                />
              </div>
            </div>
          </div>

          <div className="mb-6 hidden lg:flex lg:flex-row lg:items-center lg:justify-between lg:gap-3">
            <div className="flex min-w-0 items-center gap-2">
              <button
                onClick={() => setActiveFeed("public")}
                className={getGalleryPillClassName(activeFeed === "public")}
              >
                <span className="inline-flex h-4 w-4 shrink-0 items-center justify-center">
                  <MdPublic size={15} />
                </span>
                <span className="whitespace-nowrap">Public Albums</span>
              </button>

              {canAccessFamilyFeed ? (
                <button
                  onClick={() => setActiveFeed("family")}
                  className={getGalleryPillClassName(activeFeed === "family")}
                >
                  <span className="inline-flex h-4 w-4 shrink-0 items-center justify-center">
                    <MdPeople size={15} />
                  </span>
                  <span className="whitespace-nowrap">Family Albums</span>
                </button>
              ) : null}
            </div>

            <div className="flex w-auto flex-none items-center gap-3">
              <div className="w-[340px]">
                <input
                  ...
                  className="h-12 w-full rounded-full border border-slate-200 bg-white px-5 text-[14px] text-slate-700 shadow-sm outline-none transition focus:border-primary-400 focus:ring-2 focus:ring-primary-300/50 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:placeholder:text-slate-400"
                />
              </div>

              <button
                className="inline-flex shrink-0 items-center justify-center gap-2 rounded-full border border-[#2B7CD3] bg-[#2B7CD3] px-6 py-3 text-[15px] font-semibold text-white shadow-[0_8px_18px_rgba(43,124,211,0.18)] transition-all duration-200 hover:border-[#236AB4] hover:bg-[#236AB4] shimmer-button"
                onClick={() => setIsCreateAlbumModalOpen(true)}
              >
                <FiPlusCircle size={18} /> Create Album
              </button>
            </div>
          </div>
