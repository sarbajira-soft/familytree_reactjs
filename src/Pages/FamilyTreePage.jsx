...
const FamilyTreePage = () => {
  ...
  const canEdit =
    ...
    !isLinkedMode && isOwnTree && userInfo && (userInfo.role === 2 || userInfo.role === 3);
  ...
  const handlePersonClick = (personId) => {
    ...
    try {
      ...
      relationshipCodeToRoot = rel?.relationshipCode ? String(rel.relationshipCode) : '';
    ...
    const isSpouseCard =
      ...
      (relationshipCodeToRoot.endsWith('H') || relationshipCodeToRoot.endsWith('W'));
  ...
  const saveTreeToApi = useCallback(async () => {
    ...
    try {
      ...
      console.log(
        ...
        `✅ API response received in ${apiTime}ms (${(apiTime / 1000).toFixed(
