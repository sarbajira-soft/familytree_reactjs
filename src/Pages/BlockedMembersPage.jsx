        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-4 sm:p-6 mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
            <div className="flex items-center gap-4">
              <div className="h-14 w-14 sm:h-16 sm:w-16 bg-red-50 rounded-2xl flex items-center justify-center flex-shrink-0">
                <UserX className="h-7 w-7 sm:h-8 sm:w-8 text-red-500" />
              </div>
              <div>
                <p className="text-2xl sm:text-3xl font-bold text-gray-900">{blockedUsers.length}</p>
            ...
            {blockedUsers.map((row) => {
              ...
              return (
                <div
                  ...
                  className="group relative bg-white rounded-xl border border-gray-200 p-3 sm:p-5 hover:shadow-lg hover:border-red-200 transition-all duration-200"
                >
                  <div className="flex items-start sm:items-center gap-2 sm:gap-5">
                    {/* Avatar Section */}
                    <div className="relative flex-shrink-0">
                      <div className="h-12 w-12 sm:h-16 sm:w-16 rounded-full overflow-hidden ring-2 ring-gray-100 group-hover:ring-red-100 transition-all">
                        <img
                          src={profilePhoto}
                          alt={fullName}
                      ...
                      <div className="absolute -bottom-0.5 -right-0.5 h-5 w-5 sm:h-6 sm:w-6 bg-red-500 rounded-full flex items-center justify-center border-2 border-white shadow-sm">
                        <UserX className="h-2.5 w-2.5 sm:h-3 sm:w-3 text-white" />
                      </div>
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3 mb-1">
                        <h3 className="text-base sm:text-lg font-semibold text-gray-900 truncate">{fullName}</h3>
                        <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-700 border border-red-200 w-fit">
                          Blocked
                        </span>
                      </div>
