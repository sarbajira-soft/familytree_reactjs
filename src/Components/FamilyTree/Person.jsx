...
const Person = ({ person, isRoot, onClick, rootId, tree, language, isNew, isSelected, isHighlighted, isSearchResult, currentUserId, currentFamilyId, viewOnly, sourceRelationship }) => {
    ...
    const linkedTargetFamilyCode = person?.isExternalLinked && rawCanonicalFamilyCode && rawCanonicalFamilyCode !== currentViewFamilyCode
    ...
    const associatedTargetFamilyCode = navigationTargetFamilyCode && navigationTargetFamilyCode !== currentViewFamilyCode
                    ...
                    <div className="px-2">
                        ...
                        {person?.nodeUid && showNodeUid && (
                            ...
                            <div
                                ...
                                className="text-center mt-1 text-gray-500 dark:text-slate-400"



                                style={{ fontSize: `${Math.max(9, fontSizeRelationship - 4)}px` }}



                                title={String(person.nodeUid)}
                            ...
                            >
                                ...
                                <div className="flex items-center justify-center gap-1">
                                    ...
                                    <span className="truncate max-w-[160px]">{String(person.nodeUid)}</span>
