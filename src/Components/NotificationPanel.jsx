...
const NotificationPanel = ({ open, onClose, onNotificationCountUpdate , isConnected ,wsNotifications , refetchUnreadCount  }) => {
  ...
  const allTreeLinkRequests = notifications.filter(n => n.type === 'TREE_LINK_REQUEST');

  const totalRequestCount = allAssociationRequests.length + allTreeLinkRequests.length;
  ...
  const getFilteredNotifications = () => {
    ...
    switch (activeTab) {
      ...
      case 'requests':
        ...
        return { associationRequests: [...allAssociationRequests, ...allTreeLinkRequests], otherNotifications: [] };
      ...
      default:
        ...
        return { associationRequests: [...allAssociationRequests, ...allTreeLinkRequests], otherNotifications: allOtherNotifications };
                    ...
                    {associationGroups.today.map((notification) => {
                      ...
                      const requesterFamilyCode =
                        (isTreeLink
                          ...
                          : notification.data?.senderFamilyCode || notification.data?.requesterFamilyCode) ||
                        "Their Family";

                      const treeLinkRel = String(notification.data?.relationshipType || '').trim();
                          ...
                          <AssociationRequestItem
                            ...
                            request={{
                              ...
                              data: {
                                ...
                                requestType: isTreeLink ? "tree_link" : "family_association",

                                message: isTreeLink ? treeLinkMessage : undefined,
